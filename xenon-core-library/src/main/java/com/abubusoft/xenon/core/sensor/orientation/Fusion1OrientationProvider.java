...
public class Fusion1OrientationProvider extends OrientationProvider {
	...
	static Fusion1OrientationProvider instance;

	public static Fusion1OrientationProvider instance() {
		if (instance == null) {
			instance = new Fusion1OrientationProvider();
		}
