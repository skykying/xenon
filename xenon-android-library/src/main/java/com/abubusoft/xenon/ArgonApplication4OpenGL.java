 ...
 * 
 */
public interface ArgonApplication4OpenGL extends ArgonApplication<Argon4OpenGL>, UpdateTaskListener {
	 ...
	 */
	void onSceneCreate(final SharedPreferences sharedPreference, boolean firstSceneCreation, boolean preferencesIsChanged, boolean screenIsChanged);
	 ...
	 * @param screenIsChanged
	 */
	void onSceneRestore(SharedPreferences sharedPreference, boolean firstSceneCreation, boolean preferencesIsChanged, boolean screenIsChanged);
	 ...
	 * @param screenIsChanged
	 */
	void onSceneReady(SharedPreferences sharedPreference, boolean firstSceneCreation, boolean preferencesIsChanged, boolean screenIsChanged);
