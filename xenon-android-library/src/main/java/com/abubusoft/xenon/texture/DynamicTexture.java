...
public class DynamicTexture {
	 ...
	 * 
	 * @param values
	 *            valori che devono essere caricati di volta in volta
	 * @param optionsValue
	 *            texture options da applicare alle varie texture
	 * @param controlValue
	 *            controller che regola il caricamento delle texture
	 */
	public void init(final DynamicTextureValues values, final TextureOptions optionsValue, final DynamicTextureController controlValue) {
		...
		textureLoaderOptions = TextureReplaceOptions.build().asyncLoaderListener(new TextureAsyncLoaderListener() {
