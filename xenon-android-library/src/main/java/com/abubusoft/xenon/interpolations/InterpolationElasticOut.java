 ...
 */
public class InterpolationElasticOut implements Interpolation {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private static InterpolationElasticOut INSTANCE;

	// ===========================================================
	// Constructors
	// ===========================================================

	private InterpolationElasticOut() {

	}

	public static InterpolationElasticOut getInstance() {
		if(INSTANCE == null) {
			INSTANCE = new InterpolationElasticOut();
		}
		return INSTANCE;
	}
	...
	public float getPercentage(final float pSecondsElapsed, final float pDuration) {
		return InterpolationElasticOut.getValue(pSecondsElapsed, pDuration, pSecondsElapsed / pDuration);
	}
