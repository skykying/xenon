...
public class ArgonGLWallpaperService extends WallpaperService implements ArgonWallpaper {
	...
	public class ArgonGLEngine extends Engine {
		...
		public void onSurfaceCreated(final SurfaceHolder holder) {
			...
			if (engines == 1 && argon == null) {
				...
				argon = ArgonBeanContext.getBean(ArgonBeanType.ARGON);
				argon.onServiceCreated(ArgonGLWallpaperService.this);

				view = new WallpaperView(ArgonGLWallpaperService.this);
	...
	protected volatile Argon4OpenGL argon = null; // can be accessed from GL render thread
	protected WallpaperView view = null;
	protected ArgonGLRenderer renderer = null;
	...
	@Override
	public void setGestureDetector(ArgonGestureDetector gestureDetectorValue) {
