...
public final class ArgonEGL {
     ...
     */
    public ArgonEGL(EGLContext sharedContext, int flags) {
    ...
    private EGLConfig getConfig(int flags, int version) {
        int renderableType = ArgonGL.EGL_OPENGL_ES2_BIT;
        if (version >= 3) {
            renderableType =ArgonGL.EGL_OPENGL_ES3_BIT;
        }
