...
public class ArgonGLHelper {
	...
	public static void onStartup() {
		...
		OffscreenSurface surface = new OffscreenSurface(argonEGL, 1, 1);
		surface.makeCurrent();

		checkVersion();

		ArgonApplication4OpenGL app = ArgonBeanContext.getBean(ArgonBeanType.APPLICATION);
	...
	public static void checkVersion() {
		...
		ArgonGL.version = version;

	}

	/**
	 * <p>
	 * Verifica le estensioni presenti sul dispositivo. Il controllo viene fatto una volta sola. Sempre questo metodo è responsabile dei flag in {@link ArgonGLExtension}
	 * </p>
	 * *
	 */
	public static void checkGlExtensions() {
		...
		{
			ArgonGLExtension argonGLExtension;
