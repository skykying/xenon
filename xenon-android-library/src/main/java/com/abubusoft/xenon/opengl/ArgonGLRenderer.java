...
import com.abubusoft.xenon.android.ArgonService4OpenGL;

import android.view.MotionEvent;

public interface ArgonGLRenderer {
	...
	/**
	 * <p>Imposta il safe mode, ovvero il fatto di supportare le eccezioni durante il rendering.</p> 
	 * @param value
	 */
	void setSafeMode(boolean value);
	
	void setService(ArgonService4OpenGL service);
	

	void preserveEGLContextOnPause();
